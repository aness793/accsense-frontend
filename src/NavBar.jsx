...
import './App.css'
function NavBar() {
    var [nightMode, changeMode] = useState(false) 
    return (
        <div className="navBar">
            ...
            <div className="menu">
                <span className="language">
                    <label htmlFor="menu">Language:</label>
                    <select name="lang" id="menu" className='selectLang' >
